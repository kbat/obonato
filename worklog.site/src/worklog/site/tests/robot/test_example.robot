...
#
#  $ bin/test -s worklog.site -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src worklog.site.testing.WORKLOG_SITE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/worklog/site/tests/robot/test_example.robot
#
