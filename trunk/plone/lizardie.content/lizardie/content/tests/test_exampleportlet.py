...
from lizardie.content.portlets import exampleportlet
from lizardie.content.portlets.tests.base_exampleportlet import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(IPortletType, name='lizardie.content.portlets.ExamplePortlet')
        self.assertEquals(portlet.addview, 'lizardie.content.portlets.ExamplePortlet')
